...
namespace WebApi.Example08
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHealthChecksUI().AddSqliteStorage(GetSqlLiteStorageConnectionString());
        }
        ...
        private string GetSqlLiteStorageConnectionString()
        {
            var sqlLiteStorageConnectionString = Configuration
                .GetSection(nameof(HealthChecksSettings))
                .Get<HealthChecksSettings>()
                .SqlLiteStorageConnectionString;

            return sqlLiteStorageConnectionString;
        }
